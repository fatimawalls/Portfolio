...
function interactWithNeighbor(neighbor) {
  if (this.isHappy && !neighbor.isHappy) {
    neighbor.happyPoints += 0.1;
  } else if (!this.isHappy && neighbor.isHappy) {
    neighbor.happyPoints -= 0.1;
  }
  neighbor.isHappy = neighbor.happyPoints >= 1;
}
